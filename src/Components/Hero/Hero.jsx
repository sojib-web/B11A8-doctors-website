...
const Hero = () => {
  return (
    <div className="px-4 py-16 w-full mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 shadow-2xl rounded-2xl mt-16 mb-16 ">
      ...
      <div>
        <form className="flex flex-col md:flex-row justify-center items-center mb-8 md:px-24">
          <input
          ...
          />
          <button className="btn bg-[#176AE5] text-white rounded-2xl">
            Search Now
          </button>
        </form>
      </div>
